# springboot-security-jwt-sample
...
├── mvnw.cmd
├── pom.xml
├── springboot-security-jwt-sample.iml
└── src
    ├── main
    │   ├── java
    │   │   └── com
    │   │       └── hendisantika
    │   │           └── jwt
    │   │               └── springbootsecurityjwtsample
    │   │                   ├── SpringbootSecurityJwtSampleApplication.java
    │   │                   ├── auth
        ...
        └── java
            └── com
                └── hendisantika
                    └── jwt
                        └── springbootsecurityjwtsample
                            └── SpringbootSecurityJwtSampleApplicationTests.java
...
```
{
  "sub": "hendisantika@gmail.com",
  "scopes": [
    "ROLE_ADMIN",
    "ROLE_PREMIUM_MEMBER"
  ],
  "iss": "http://hendisantika.com",
  "iat": 1472033308,
  "exp": 1472034208
}
```
